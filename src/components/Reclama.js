...
export const Reclama=({setReclama})=>{
    ...
    return(
        <div className="mis-fichas">
            <div className='fondo-album' style={{top: '0%', background: 'url("https://static.vecteezy.com/system/resources/thumbnails/003/368/024/small/football-for-banner-soccer-championship-2022-in-qatar-vector.jpg") 60% 50%'}}>
